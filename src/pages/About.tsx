    ...
    <div className="bg-gray-50">
      ...
      <div className="relative bg-white overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-brand-50/80 to-white/80" />
        </div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <img
              ...
              alt="TSMC Logo"
              className="h-24 sm:h-32 md:h-36 lg:h-40 w-auto mx-auto mb-8 object-scale-down transition-all duration-300 hover:scale-105 border-2 border-brand-600 rounded-md"
              width="160"
              height="160"
            />
            <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block text-brand-600">About TSMC</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="relative group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-brand-900/20 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </div>
            ...
            <div className="flex flex-col justify-center space-y-6">
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Since 2011, our team has been united by a singular mission: <strong className="text-brand-600">to transform Philippine healthcare through innovative medical solutions and unwavering partnership.</strong>
                </p>
              </div>

              <div className="bg-brand-50 rounded-lg p-6 border-l-4 border-brand-600">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg shadow-md border border-gray-200">
                  <div className="text-3xl font-bold text-brand-600 mb-1">13+</div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <Award className="h-6 w-6 text-brand-600 mr-3 flex-shrink-0 mt-1" />
                ...
                <div className="flex items-start">
                  <Users className="h-6 w-6 text-brand-600 mr-3 flex-shrink-0 mt-1" />
                  <p className="text-gray-700">
                ...
                <div className="flex items-start">
                  <Heart className="h-6 w-6 text-brand-600 mr-3 flex-shrink-0 mt-1" />
                  <p className="text-gray-700">
          ...
          <div className="mt-12">
            <div className="relative group overflow-hidden rounded-2xl shadow-2xl">
              <img
                ...
                className="w-full h-auto object-cover transform transition-transform duration-500 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-brand-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 h-fit">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <Stethoscope className="h-5 w-5 text-brand-600 mr-3" />
                ...
                <div className="flex items-center">
                  <Globe className="h-5 w-5 text-brand-600 mr-3" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="flex items-center mb-6">
                <div className="flex items-center justify-center h-12 w-12 rounded-md bg-brand-500 text-white mr-4">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-brand-600 rounded-full mr-2"></div>
      ...
      <div className="bg-brand-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/tsmc"
              className="inline-flex items-center px-8 py-4 border border-transparent text-lg font-medium rounded-md text-brand-600 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 transition-all duration-300"
            >
              View Our Products
            ...
            <Link
              to="/contact"
              className="inline-flex items-center px-8 py-4 border-2 border-white text-lg font-medium rounded-md text-white hover:bg-white hover:text-brand-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white transition-all duration-300"
            >
              Contact Us
