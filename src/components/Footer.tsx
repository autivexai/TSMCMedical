        ...
        <div className="grid grid-cols-1 gap-8">
          <Link to="/tsmc" className="group transition-colors duration-200 hover:bg-gray-700/50 p-4 rounded-lg">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-base sm:text-lg font-semibold">TSMC Medical Supply</h3>
            </div>
            <p className="text-sm sm:text-base text-gray-300 group-hover:text-gray-200">Quality medical equipment and supplies for healthcare professionals.</p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
            <div className="text-center sm:text-left">
              <p className="text-sm text-gray-400">&copy; {currentYear} Twinj3 Sales and Marketing Corp. All rights reserved.</p>
            </div>
